...
export const DEFAULT_INVENTORY_COLS = 9;
export const DEFAULT_TOTAL_SLOTS = 36;
 ...
 */
export function validateInventorySlots(slots, maxSlots) {
 ...
 */
export function serializeInventory(slots, selectedHotbarSlot) {
 ...
 */
export function computeInventoryDiff(oldSlots, newSlots) {
  const changes = [];
 ...
 */
export function applyInventoryDiff(slots, changes) {
  const result = [...slots];
 ...
 */
export function countItemInSlots(slots, typeId) {
  let total = 0;
 ...
 */
export function hasItemInSlots(slots, typeId) {
