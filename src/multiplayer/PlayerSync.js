...
import { distanceBetween } from '../util/MathUtils.js';
...
export const REMOTE_PLAYER_STATES = {
...
export const DEFAULT_REMOTE_PLAYER = {
 ...
 */
export function buildVoxelCharacter(color) {
...
export class PlayerSyncManager {
  constructor(config) {
    ...
    // PR 9: THREE is imported, so `typeof THREE` is now a constant `true` and no
    // longer distinguishes a browser from Node. The flag's MEANING is unchanged —
 ...
 */
export function isInRenderDistance(pos1, pos2, maxDistance) {
