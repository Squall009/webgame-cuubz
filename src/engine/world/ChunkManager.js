...
// IIFE because the same file is also evaluated on the main thread as the inline
// fallback (see src/index.js). Both are therefore imported for their URL only — they
// are not part of the module graph — and are spawned as classic workers.
