...
import { Chunk } from './ChunkData.js';

// Node.js: require the Chunk class from chunkData (decode() constructs one);
export const CHUNK_MAGIC = 0x43555542; // "CUUB"
export const CHUNK_VERSION = 3;       // v3: Y-major block data layout
export const LEGACY_LAYOUT_MAX = 2;   // v1 and v2 use X-major — must regenerate
export const HEADER_SIZE = 20;
export const _CHUNK_HEIGHT = 256;     // Must match CHUNK_HEIGHT from chunkData.js
...
// Flag bits
export const CHUNK_FLAG_DIRTY = 0x01;

export class ChunkBinaryCodec {
  /**
