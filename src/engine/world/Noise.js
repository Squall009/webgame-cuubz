...
export function fbm2(perlin, x, y, octaves, persistence, lacunarity) {
...
export function applySpline(val, points) {
...
export function createSharedPerlin(seed) {
...
export function createPRNG(subSeed, seed = 0) {
