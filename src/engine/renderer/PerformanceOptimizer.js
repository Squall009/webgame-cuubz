...
export const RENDER_DISTANCE_BY_TIER = {
...
export const ADJUSTMENT_INTERVAL = 2000; // Check FPS every 2 seconds
export const ADJUSTMENT_STEP = 1;        // Render distance change per adjustment
export const ADJUSTMENT_COOLDOWN = 5000; // Minimum time between adjustments
 ...
 * @returns {boolean}
 */
export function isTouchDevice(options = {}) {
 ...
 */
export function estimateDeviceTier(glInfo) {
  if (!glInfo) {
 ...
 */
export function calculateRecommendedRenderDistance(tier, isMobile) {
 ...
 */
export function calculateFPSTarget(isMobile) {
 ...
 */
export function calculateChunkCount(radius) {
 ...
 */
export function estimateMemoryUsage(radius) {
 ...
 */
export function shouldReduceRenderDistance(currentFPS, targetFPS, currentRenderDistance) {
 ...
 */
export function shouldIncreaseRenderDistance(currentFPS, targetFPS, currentRenderDistance) {
 ...
 */
export function calculateNewRenderDistance(fps, targetFPS, currentDistance) {
