...
import { DRINKING, EATING } from '../../game/systems/SurvivalSystem.js';
...
export const MATERIAL_SOUND_PARAMS = {
...
export const SPECIAL_SFX_PARAMS = {
 ...
 */
export function getMaterialParams(material, isPlace) {
 ...
 */
export function getFootstepParams(surface) {
 ...
 */
export function getSpecialSfxParams(name) {
 ...
 */
export function calculateVolume(soundVolume, masterVolume, categoryVolume) {
 ...
 */
export function blockIdToMaterial(blockTypeId) {
  const mapping = {
 ...
 */
export function biomeToFootstepSurface(biomeName) {
  const mapping = {
 ...
 */
export function generateNoiseBuffer(sampleCount, seed) {
 ...
 */
export function sampleRange(samples) {
