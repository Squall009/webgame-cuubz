 ...
 */
export const BIOME_AMBIENT_CONFIG = {
  plains: {
    rootNote: 'A3',
...
export const DAY_NIGHT_VOLUMES = {
...
export const DEFAULT_AMBIENT_VOLUME = {
  master: 0.5,
};
 ...
 */
export const BIOME_SOUND_LAYERS = {
  plains: [
...
export const VALID_LAYER_TYPES = ['crackle', 'whisper', 'birds', 'wind', 'bubbles'];
 ...
 */
export function calculateChordFrequencies(rootNote, scale, chordDegrees) {
 ...
 */
export function getBiomeAmbientConfig(biomeName) {
 ...
 */
export function calculateDayNightVolume(baseVolume, timeOfDay, masterVolume) {
  // Clamp inputs
 ...
 */
export function calculateSwellVolume(elapsedSeconds, swellSpeed) {
 ...
 */
export function calculateDetunedFrequency(baseFreq, detuneCents) {
 ...
 */
export function validateBiomeConfig(biomeName) {
 ...
 */
export function getBiomeSoundLayers(biomeName) {
 ...
 */
export function validateSoundLayer(layer) {
  if (!layer || !layer.type) {
 ...
 */
export function resolveSoundLayer(layer) {
  const defaults = LAYER_DEFAULTS[layer.type];
 ...
 */
export function calculateCrackleSchedule(rate, burstDuration, windowSeconds, seed) {
  const events = [];
  let rng = seed || 42;
 ...
 */
export function calculateBirdSchedule(rate, chirpCount, pitchRange, windowSeconds, seed) {
  const events = [];
  let rng = seed || 123;
 ...
 */
export function calculateBubbleSchedule(freqBase, freqRange, rate, pulseWidth, windowSeconds, seed) {
  const events = [];
  let rng = seed || 777;
 ...
 */
export function calculateAtmosphericVolume(layerVolume, timeOfDay, masterVolume) {
 ...
 */
export function getAllUsedLayerTypes() {
  const types = new Set();
 ...
 */
export function getBiomesUsingLayerType(type) {
 ...
 */
export function validateAllSoundLayers() {
  const errors = [];
