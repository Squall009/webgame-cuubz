...
import { QUEST_REGISTRY } from '../systems/QuestSystem.js';
...
export const MARKER_HEIGHT = 2.0;         // Total height in blocks
export const MARKER_WIDTH = 0.3;          // Post width in blocks
export const INTERACTION_RANGE = 3.0;     // Blocks — player must be within this to interact
export const VISIBILITY_RADIUS = 64.0;    // Blocks — marker visible from this distance
export const GLOW_PULSE_SPEED = 2.0;      // Radians per second for glow animation
export const PARTICLE_COUNT = 8;          // Number of particles orbiting the marker
