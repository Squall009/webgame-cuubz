...
// Damage source constants — the single copy lives in src/game/data/DamageSources.js
export const ENVIRONMENTAL_DAMAGE_RATES = {
...
export const FALL_DAMAGE_CONFIG = {
 ...
 */
export function getBlockDamageSource(blockType) {
 ...
 * @returns {boolean}
 */
export function isDamagingBlock(blockType) {
 ...
 */
export function getEnvironmentalDamageRate(source) {
 ...
 */
export function getBossAttackProfile(bossKey) {
 ...
 */
export function calculateBossAttackDamage(attack, phase = 1) {
 ...
 */
export class DamageFlashEffect {
  constructor() {
    this.active = false;
