...
const { BLOCK_BY_NAME, BLOCK_PROPERTIES, BLOCK_REGISTRY } = require('../src/engine/world/BlockRegistry.js');
const { isAir, isPassable, isSolidBlock } = require('../src/game/data/BlockCategories.js');
const {
  _checkStepUp, _moveAndCollide, _resolveAxis, applyFlyingMovement,
} = require('../src/game/mobs/movement/mobMovement.js');
