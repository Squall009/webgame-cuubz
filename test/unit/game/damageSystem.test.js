...
import { DamageSystem, DamageFlashEffect, DAMAGE_SOURCES, ENVIRONMENTAL_DAMAGE_RATES, POISON_CONFIG, FALL_DAMAGE_CONFIG, BOSS_ATTACKS, getBlockDamageSource, isDamagingBlock, calculateFallDamage, getEnvironmentalDamageRate, getBossAttackProfile, calculateBossAttackDamage, getBossKeys } from '../../../src/game/systems/DamageSystem.js';

it('damageSystem', () => legacy(async () => {
let passed = 0;
let failed = 0;
