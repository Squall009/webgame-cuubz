...
import { BOSS_STATES, BOSS_DEFINITIONS, Boss, BossManager, getBossDefinition, getAllBossIds, distanceBetween, squaredDistance } from '../../../src/game/entities/Boss.js';

it('boss', () => legacy(async () => {
let passed = 0;
let failed = 0;
let total = 0;
