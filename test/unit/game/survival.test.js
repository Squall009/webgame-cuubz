...
import { SurvivalSystem, DAMAGE_SOURCES, DEFAULT_METERS, STAMINA_COSTS, RESTORATION, FOOD_ITEMS, EATING, DRINKING, BED, BED_COLORS } from '../../../src/game/systems/SurvivalSystem.js';
import { SEA_LEVEL } from '../../../src/engine/world/ChunkData.js';

it('survival', () => legacy(async () => {
