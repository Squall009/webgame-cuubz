...
import { MARKER_HEIGHT, MARKER_WIDTH, INTERACTION_RANGE, VISIBILITY_RADIUS, GLOW_PULSE_SPEED, PARTICLE_COUNT, MARKER_COLORS, DEFAULT_MARKER_COLOR, QuestMarker, QuestMarkerManager } from '../../../src/game/entities/QuestMarker.js';
import { QuestSystem } from '../../../src/game/systems/QuestSystem.js';

it('questMarker', () => legacy(async () => {
