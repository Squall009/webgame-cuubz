...
import { Game, BlockPalette } from '../../../src/core/Game.js';
import { Player } from '../../../src/game/entities/Player.js';
import { BLOCK_TYPES } from '../../../src/engine/world/ChunkData.js';
import { InputAction } from '../../../src/engine/input/Keyboard.js';

it('creativeMode', () => legacy(async () => {
let passed = 0;
let failed = 0;
let testGroup = '';
...
const emptyPalette = new BlockPalette();
