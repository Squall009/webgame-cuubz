...
import {
  ...
  HostRemotePlayer,
  HostManager,
} from '../../../src/multiplayer/Host.js';

it('hostLogic', () => legacy(async () => {
...
// Add a remote player
const movePlayer = new HostRemotePlayer(
  'move_p1',
...
const blockPlayer = new HostRemotePlayer(
  'block_p1',
...
const invPlayer = new HostRemotePlayer(
  'inv_p1',
...
const kickPlayer = new HostRemotePlayer(
  'kick_p1',
...
const sPlayer = new HostRemotePlayer(
  's_p1',
...
const cdPlayer = new HostRemotePlayer(
  'cd_p1',
...
const cdPlayer2 = new HostRemotePlayer(
  'cd_p2',
