...
import { CLIENT_STATE, DEFAULT_CONFIG, MESSAGE_TYPES, MessageQueue, WSConnection, MultiplayerClient } from '../../../src/multiplayer/Client.js';

it('multiplayerClient', () => legacy(async () => {
let passCount = 0;
let failCount = 0;
const failures = [];
