...
const {
  canOpen, hideBanner, parseSeed, randomHexColor, randomSeed,
  SEED_ERROR, setBanner, submitCreate, syncCreateButton,
} = require('../src/ui/forms/createEntity.js');
const { CharacterManager, DEFAULT_COLOR, MAX_CHARACTERS } = require('../src/game/entities/CharacterManager.js');
const { WorldManager, MAX_WORLDS } = require('../src/game/entities/WorldManager.js');
...
(async function run() {
  ...
  const { initBrowseCreateChar, initHostForm } = require('../src/ui/screens/LobbyForms.js');
