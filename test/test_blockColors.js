...
const { BLOCK_BY_NAME } = require('../src/engine/world/BlockRegistry.js');
const { FALLBACK_COLOR, getBlockColor, registerBlockColorAtlas } = require('../src/game/data/BlockColors.js');
