...
const { BIOME_DEFS, BIOME_IDS, BIOME_NAME_TO_ID, BiomeSystem } = require('../src/engine/world/BiomeSystem.js');
const { MOB_DEFINITIONS, selectMobForBiome } = require('../src/game/mobs/mobDefinitions.js');
