...
import { CHUNK_WIDTH, CHUNK_DEPTH } from '../../src/engine/world/ChunkData.js';
import { ChunkStreamer, CHUNK_STATE, DEFAULT_STREAM_CONFIG } from '../../src/multiplayer/ChunkStreamer.js';

it('chunkStreaming', () => legacy(async () => {
// ─── Test Harness ──────────────────────────────────────────────
