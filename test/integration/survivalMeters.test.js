...
import { SurvivalSystem, DAMAGE_SOURCES, DEFAULT_METERS, STAMINA_COSTS, STAMINA_REGEN, FOOD_ITEMS, BED, DRINKING } from '../../src/game/systems/SurvivalSystem.js';

it('survivalMeters', () => legacy(async () => {
let passed = 0;
let failed = 0;
