...
import { QuestSystem, QUEST_REGISTRY, QUEST_TYPES, QUEST_STATES } from '../../src/game/systems/QuestSystem.js';
import { QuestMarker, QuestMarkerManager, INTERACTION_RANGE, VISIBILITY_RADIUS } from '../../src/game/entities/QuestMarker.js';

it('quest', () => legacy(async () => {
// ============================================================
// Test Setup
// ============================================================
