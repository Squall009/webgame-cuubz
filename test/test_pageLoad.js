...
const requiredFiles = [
  ...
  'js/world/workerGeneration.js',
  'js/world/chunkBinaryCodec.js',
  'js/chunkmanager.js',  // Monolithic chunk manager (replaces chunkStore, dirtyFlushManager, worldGenerator, chunkGrid)
  'js/world/persistence.js',
  'js/world/spawnManager.js',
  'js/renderer/textureAtlas.js',
  'js/renderer/chunkMeshBuilder.js',
  'js/renderer/meshWorker.js',
