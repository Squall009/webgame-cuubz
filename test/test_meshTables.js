...
const { BLOCK_REGISTRY, BLOCK_BY_ID, BLOCK_BY_NAME } = require('../src/engine/world/BlockRegistry.js');
const { ChunkMeshBuilder } = require('../src/engine/renderer/ChunkMeshBuilder.js');
const { FACE_TABLE, HORIZONTAL_FACES } = require('../src/game/data/FaceTable.js');
const {
  AIR_IDS, CUTOUT_IDS, TRANSPARENT_IDS, TINTABLE_IDS, buildMeshTables, isPassable, isSolidBlock,
} = require('../src/game/data/BlockCategories.js');
...
const { BLOCK_PROPERTIES } = require('../src/engine/world/BlockRegistry.js');
