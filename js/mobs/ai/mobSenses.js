 ...
 * @returns {boolean}
 */
function canSeeTarget(mob, targetPosition, blockAccess) {
 ...
 * @returns {boolean}
 */
function shouldAggro(mob, playerPosition, blockAccess) {
 ...
 * @returns {boolean}
 */
function shouldLoseAggro(mob, playerPosition) {
 ...
 * @returns {boolean}
 */
function shouldFlee(mob, playerPosition) {
  if (!playerPosition) return false;
 ...
 */
function detectPackMembers(mob, otherMobs) {
 ...
 * @param {{x:number,y:number,z:number}} playerPosition
 */
function triggerPackAggro(mob, otherMobs, playerPosition) {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    canSeeTarget, shouldAggro, shouldLoseAggro, shouldFlee,
    detectPackMembers, triggerPackAggro,
  };
}