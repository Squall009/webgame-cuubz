 ...
 */
function updateAI(mob, deltaTime, blockAccess, playerPosition, allMobs, applyMovementFn) {
 ...
 */
function _stateIdle(mob, deltaTime, playerPosition, playerInAggro, playerInSense) {
  if (mob.aiTimer <= 0) {
 ...
 */
function _stateWander(mob, deltaTime, blockAccess, playerPosition, playerInAggro, playerInSense, applyMovementFn) {
 ...
 */
function _stateChase(mob, deltaTime, blockAccess, playerPosition, playerInAttackRange, applyMovementFn) {
 ...
 */
function _stateAttack(mob, deltaTime, playerPosition, blockAccess) {
 ...
 */
function _stateFlee(mob, deltaTime, blockAccess, playerPosition, applyMovementFn) {
  if (!playerPosition) {
    mob.aiState = AI_STATES.IDLE;
 ...
 */
function _stateReturnHome(mob, deltaTime, blockAccess, applyMovementFn) {
 ...
 */
function _pickWanderTarget(mob) {
