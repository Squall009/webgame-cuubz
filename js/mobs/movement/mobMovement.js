 ...
 */
function applyGroundMovement(mob, targetX, targetZ, deltaTime, blockAccess) {
 ...
 */
function applyFlyingMovement(mob, targetX, targetZ, deltaTime, blockAccess) {
 ...
 */
function _moveAndCollide(mob, deltaTime, world) {
  if (!world) {
 ...
 */
function _checkStepUp(mob, deltaTime, hw, hh, world) {
 ...
 */
function _resolveAxis(mob, newX, newY, newZ, hw, hh, axis, world) {
 ...
 * @param {object} blockAccess
 */
function applyMovement(mob, targetX, targetZ, deltaTime, blockAccess) {
  if (mob.isFlying) {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { applyMovement, applyGroundMovement, applyFlyingMovement };
}