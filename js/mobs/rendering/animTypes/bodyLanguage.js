 ...
 */
function breathingIdle(group, time) {
 ...
 */
function twitchIdle(group, time) {
  const parts = group.userData.parts;
  const init = group.userData.initialTransforms;
  if (!parts) return;
 ...
 */
function rockingIdle(group, time) {
  const parts = group.userData.parts;
  const init = group.userData.initialTransforms;
  if (!parts) return;
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { breathingIdle, twitchIdle, rockingIdle, hoverIdle };
}