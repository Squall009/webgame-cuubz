 ...
 */
function collapseDeath(group, progress) {
  // Fall over sideways
 ...
 * @param {number} progress - 0 to 1
 */
function crumbleDeath(group, progress) {
  // Sink into ground
 ...
 * @param {number} progress - 0 to 1
 */
function dissolveDeath(group, progress) {
  // Float upward
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { collapseDeath, crumbleDeath, dissolveDeath };
}