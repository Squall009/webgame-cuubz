 ...
 * @returns {object|null}
 */
function getMobDefinition(mobType) {
 ...
 */
function getMobTypesForBiome(biome) {
  const types = [];
 ...
 */
function selectMobForBiome(biome) {
  const candidates = [];
  for (const [key, def] of Object.entries(MOB_DEFINITIONS)) {
    if (def.biomes.includes(biome)) {
...
if (typeof module !== 'undefined' && module.exports) {
  module.exports = {
    MOB_CATEGORIES, MOB_BEHAVIORS, AI_STATES, ANIM_TYPES,
    MOB_DEFINITIONS, getMobDefinition, getAllMobTypes,
