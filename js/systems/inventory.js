...
const NAMED_ITEMS = {
  ...
  // ── Tools: Wooden ──────────────────────────────────────────
  wooden_sword:   { name: 'Wooden Sword', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 4, attackSpeed: -2.4 },
  ...
  stone_spear:    { name: 'Stone Spear', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 6, attackSpeed: -1.8 },
  // ── Tools: Copper ──────────────────────────────────────────
  copper_sword:   { name: 'Copper Sword', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 4, attackSpeed: -2.4 },
  ...
  copper_spear:   { name: 'Copper Spear', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 5, attackSpeed: -1.8 },
  // ── Tools: Iron ────────────────────────────────────────────
  iron_sword:     { name: 'Iron Sword', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 6, attackSpeed: -2.4 },
  ...
  iron_spear:     { name: 'Iron Spear', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 7, attackSpeed: -1.8 },
  // ── Tools: Gold ────────────────────────────────────────────
  golden_sword:   { name: 'Golden Sword', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 4, attackSpeed: -1.6 },
  ...
  golden_spear:   { name: 'Golden Spear', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 5, attackSpeed: -1.4 },
  // ── Tools: Diamond ─────────────────────────────────────────
  diamond_sword:  { name: 'Diamond Sword', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 7, attackSpeed: -2.4 },
  ...
  diamond_spear:  { name: 'Diamond Spear', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 8, attackSpeed: -1.8 },
  // ── Tools: Netherite ───────────────────────────────────────
  netherite_sword:  { name: 'Netherite Sword', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 8, attackSpeed: -2.4 },
  ...
  netherite_spear:  { name: 'Netherite Spear', category: ITEM_CATEGORIES.TOOL, maxStack: 1, damage: 9, attackSpeed: -1.8 },
  // ── Armor: Leather ─────────────────────────────────────────
